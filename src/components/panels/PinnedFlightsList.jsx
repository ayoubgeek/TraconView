        ...
        {pinnedList.map(ac => {
          ...
          return (
            <button
              ...
              className={`w-full text-left px-4 py-2 flex items-center justify-between border-b border-[#1A2235]/50 transition-colors ${isSelected ? 'bg-atc-green/10 text-atc-green' : 'text-slate-300 hover:bg-[#1A2235]/40 hover:text-white'}`}
            >
